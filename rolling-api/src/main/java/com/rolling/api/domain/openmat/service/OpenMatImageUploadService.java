...
public class OpenMatImageUploadService {

    private static final String IMAGE_PREFIX = "openmats/images/";
    ...
    public OpenMatImageUploadUrlResponse createUploadUrl(OpenMatImageUploadUrlRequest request) {
        ...
        try {
            ...
            return OpenMatImageUploadUrlResponse.builder()
                    .uploadUrl(uploadUrl)
                    .imageKey(imageKey)
