...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=pzgrGCdYl_4',
    TRUE,
    1,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=k54daRsX3co',
    TRUE,
    2,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=mVkKOPNGvjA',
    TRUE,
    3,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=4q_TMA7usDw',
    TRUE,
    4,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=QYJxHtTuOAw',
    TRUE,
    5,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=YvJ-PVhKiWI',
    TRUE,
    6,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=LU7bEi96ink',
    TRUE,
    7,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=EM4xc2XSBrE',
    TRUE,
    9,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=G499sHSEk3o',
    TRUE,
    10,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=JDJYWBbzspQ',
    TRUE,
    11,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=p9iBzTpXGD4',
    TRUE,
    13,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=avrcVQ2mQIw',
    TRUE,
    15,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=ZBLTVlH3Rb0',
    TRUE,
    16,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=KjYuOdMKZfs',
    TRUE,
    17,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=oe-xUmRLcUg',
    TRUE,
    18,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=iUqtvbW3mJQ',
    TRUE,
    19,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=FyqaWxyMtLc',
    TRUE,
    20,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=4hAY12ghrGk',
    TRUE,
    22,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=BZGvAiMzUAM',
    TRUE,
    24,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=dpuKJPsq84g',
    TRUE,
    25,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=ZZ15qbqTcTA',
    TRUE,
    27,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=1B_mWDcIybw',
    TRUE,
    30,
    NOW(),
    NOW()
...
INSERT INTO training_cards (
    ...
    'https://www.youtube.com/watch?v=F0Qz-DcqxJw',
    TRUE,
    34,
    NOW(),
    NOW()
