...
- 현재 알림 type 예시에는 `COMMUNITY_COMMENT_CREATED`, `FRIEND_REQUEST_RECEIVED`, `TRAINING_LOG_COMMENT_CREATED`, `TRAINING_LOG_COMMENT_REPLY_CREATED`, `INQUIRY_ANSWERED`가 포함된다.
