...
@Entity
@Table(
        name = "training_log_comment_reports",
        uniqueConstraints = {
                @UniqueConstraint(columnNames = {"comment_id", "reporter_id"})
        },
        indexes = {
                @Index(name = "idx_training_log_comment_reports_comment", columnList = "comment_id"),
                @Index(name = "idx_training_log_comment_reports_reporter", columnList = "reporter_id")
        }
)
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class TrainingLogCommentReport extends BaseTimeEntity {
    ...
    private TrainingLogComment comment;
    ...
    @Builder
    public TrainingLogCommentReport(
