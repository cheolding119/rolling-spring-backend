...
public class CommunityPostImageUploadService {

    private static final String IMAGE_PREFIX = "community/posts/images/";
    ...
    public CommunityPostImageUploadUrlResponse createUploadUrl(CommunityPostImageUploadUrlRequest request) {
        ...
        try {
            ...
            return CommunityPostImageUploadUrlResponse.builder()
                    .uploadUrl(uploadUrl)
                    .imageKey(imageKey)
