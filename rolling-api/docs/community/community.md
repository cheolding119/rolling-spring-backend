...
- [ ] 관리자 게시글 목록 조회 API 구현
- [ ] 관리자 게시글 상세 조회 API 구현
- [ ] 관리자 게시글 숨김 API 구현
- [ ] 관리자 게시글 숨김 해제 API 구현
- [ ] 관리자 댓글 숨김 API 구현
- [ ] 관리자 댓글 숨김 해제 API 구현
- [ ] 관리자 게시글 신고 목록 조회 API 구현
- [ ] 관리자 댓글 신고 목록 조회 API 구현
- [ ] 신고 상태 변경 API 구현
- [ ] 운영 메모 저장 여부 결정 및 구현
- [ ] 관리자 API `ROLE_ADMIN` 권한 검증 테스트 추가
...
- [ ] 댓글 작성 시 게시글 작성자에게 앱 내 알림 저장
- [ ] 자기 게시글에 직접 댓글을 단 경우 알림 미생성
- [ ] 커뮤니티 알림 타입 추가
- [ ] 알림 route 정책 정의
- [ ] FCM 발송 여부와 DB 알림 저장 책임 분리
